...
public:
    ...
    WireframeObject& setColor(const Color3& color) { _drawableObj->setColor(color); return *this; }
    WireframeObject& transform(const Matrix4& transMatrix) { _obj3D->transform(transMatrix); return *this; }
    WireframeObject& setTransformation(const Matrix4& transMatrix) { _obj3D->setTransformation(transMatrix); return *this; }
...
public:
    explicit WireframeBox(Scene3D* const scene, SceneGraph::DrawableGroup3D* const drawableGroup) :
...
public:
    explicit WireframeGrid(Scene3D* const scene, SceneGraph::DrawableGroup3D* const drawableGroup) :
        WireframeObject(scene, drawableGroup) {
